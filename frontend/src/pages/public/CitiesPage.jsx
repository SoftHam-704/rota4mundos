...
const ALL_CITIES = [
    ...
    { name: "Sidrolândia",            country: "BR", state: "Mato Grosso do Sul",    population: "~51.000", tagline: "O Coração Produtivo do Mato Grosso do Sul", desc: "Cinturão agroindustrial do MS. Povo Terena, soja, milho e logística bioceânica no corredor entre Campo Grande e a fronteira.", href: "/cidades/sidrolandia",           accent: "#C8922A", accentRgb: "200,146,42",   image: "/cities/sidrolandia.jpg",           routeOrder: 2  },
    { name: "Jardim",                 country: "BR", state: "Mato Grosso do Sul",    population: "27.245",  tagline: "Portal da Serra da Bodoquena",             desc: "Sede da Serra da Bodoquena com cavernas, grutas e paisagens únicas do planalto calcário.",                                      href: "/cidades/jardim",                accent: "#86efac", accentRgb: "134,239,172",  image: "/cities/jardim.jpg",                routeOrder: 3  },
    { name: "Bonito",                 country: "BR", state: "Mato Grosso do Sul",    population: "21.368",  tagline: "O Aquário Natural do Mundo",               desc: "Rios cristalinos de 40m de visibilidade, grutas e cachoeiras. Referência global em ecoturismo.",                                    href: "/cidades/bonito",                accent: "#22d3ee", accentRgb: "34,211,238",   image: "/cities/bonito.jpg",                routeOrder: 4  },
    { name: "Porto Murtinho",         country: "BR", state: "Mato Grosso do Sul",    population: "12.859",  tagline: "A Guardiã do Rio Paraguai",                desc: "Última cidade brasileira antes da travessia. Pantanal, Toro Candil e a ponte binacional sobre o Rio Paraguai.",                     href: "/cidades/porto-murtinho",        accent: "#F4A261", accentRgb: "244,162,97",   image: "/cities/porto_murtinho.jpg",        routeOrder: 5  },
    { name: "Carmelo Peralta",        country: "PY", state: "Alto Paraguay",         population: "5.000",   tagline: "A Travessia Histórica",                    desc: "Fronteira com Porto Murtinho — onde a ponte binacional sobre o Rio Paraguai conecta dois oceanos.",                                   href: "/cidades/carmelo-peralta",       accent: "#818cf8", accentRgb: "129,140,248",  image: "/cities/carmelo_peralta.jpg",       routeOrder: 6  },
    ...
    { name: "Filadelfia",             country: "PY", state: "Boquerón",              population: "14.000",  tagline: "A Alma Europeia do Chaco",                 desc: "Colônia mennonita que transformou o deserto em polo agroindustrial. Queijos, embutidos e cooperativismo.",                           href: "/cidades/filadelfia",            accent: "#84cc16", accentRgb: "132,204,22",   image: "/cities/filadelfia.jpg",            routeOrder: 8  },
    { name: "Tartagal",               country: "AR", state: "Salta — NOA",           population: "70.000",  tagline: "Fronteira Cultural do Norte Argentino",    desc: "Cinco povos originários ativos, floresta subtropical das Yungas e carnaval multicultural do NOA.",                                   href: "/cidades/tartagal",              accent: "#10b981", accentRgb: "16,185,129",   image: "/cities/tartagal.jpg",              routeOrder: 9  },
    { name: "Jujuy",                  country: "AR", state: "Província de Jujuy",    population: "320.000", tagline: "A Alma Ancestral dos Andes",               desc: "Quebrada de Humahuaca (UNESCO), Cerro de los Siete Colores e Pachamama viva há 10.000 anos.",                                         href: "/cidades/jujuy",                 accent: "#f43f5e", accentRgb: "244,63,94",    image: "/cities/jujuy.jpg",                 routeOrder: 10 },
    { name: "Salta",                  country: "AR", state: "Província de Salta",    population: "620.000", tagline: "La Linda — Capital do Folclore Andino",    desc: "Centro histórico colonial, Tren a las Nubes a 4.220m e peñas folclóricas com zamba ao vivo.",                                      href: "/cidades/salta",                 accent: "#f97316", accentRgb: "249,115,22",   image: "/cities/salta.jpg",                 routeOrder: 11 },
    { name: "Antofagasta",            country: "CL", state: "Região de Antofagasta", population: "500.000", tagline: "Onde o Atacama Beija o Pacífico",          desc: "La Portada, observatórios ESO, capital do cobre e o porto onde o continente encontra o oceano.",                                      href: "/cidades/antofagasta",           accent: "#38bdf8", accentRgb: "56,189,248",   image: "/cities/antofagasta.jpg",           routeOrder: 12 },
    { name: "Iquique",                country: "CL", state: "Região de Tarapacá",    population: "235.000", tagline: "Porto Histórico e Zona Franca",            desc: "Humberstone UNESCO, Cerro Dragón, memória salitreira e ZOFRI — a cidade que se reinventou sem perder a alma.",                      href: "/cidades/iquique",               accent: "#fb923c", accentRgb: "251,146,60",   image: "/cities/iquique.jpg",               routeOrder: 13 },
    { name: "Mejillones",             country: "CL", state: "Região de Antofagasta", population: "12.000",  tagline: "O Porto Autêntico do Pacífico",            desc: "Encerramento simbólico da rota. Porto artesanal centenário, pesca viva e o pôr do sol mais emocionante da travessia.",              href: "/cidades/mejillones",            accent: "#0891b2", accentRgb: "8,145,178",    image: "/cities/mejillones.jpg",            routeOrder: 14 },
];
                ...
                <div className="container-rota" style={{ position: "relative" }}>
                    <motion.div initial={{ opacity: 0, y: 40, filter: "blur(12px)" }} animate={{ opacity: 1, y: 0, filter: "blur(0px)" }} transition={{ duration: 0.9 }}>
                        ...
                        <p style={{ fontSize: "16px", color: "rgba(255,255,255,0.45)", lineHeight: 1.75, fontFamily: "Inter, sans-serif", maxWidth: "520px" }}>
                            De Campo Grande a Mejillones — 14 cidades, 4 países, 3.500 km. O maior corredor bioceânico da América do Sul, contado pelos seus povos, sabores e paisagens.
                        </p>
                ...
                <div className="container-rota">
                    <div style={{ display: "flex", gap: "6px", padding: "12px 0", flexWrap: "wrap" }}>
                        <button onClick={() => setActiveCountry("ALL")}
                            ...
                            Toda a rota <span style={{ fontWeight: 800, fontSize: "10px" }}>14</span>
                        </button>
                        {COUNTRIES.map(c => {

...
const ALL_CITIES = [
    ...
    { name: "Sidrolândia",            country: "BR", state: "Mato Grosso do Sul",    population: "~51.000", tagline: "O Coração Produtivo do Mato Grosso do Sul", desc: "Cinturão agroindustrial do MS. Povo Terena, soja, milho e logística bioceânica no corredor entre Campo Grande e a fronteira.", href: "/cidades/sidrolandia",           accent: "#C8922A", accentRgb: "200,146,42",   image: "/cities/sidrolandia.png",           routeOrder: 2  },
    ...
    { name: "Bonito",                 country: "BR", state: "Mato Grosso do Sul",    population: "21.368",  tagline: "O Aquário Natural do Mundo",               desc: "Rios cristalinos de 40m de visibilidade, grutas e cachoeiras. Referência global em ecoturismo.",                                    href: "/cidades/bonito",                accent: "#22d3ee", accentRgb: "34,211,238",   image: "/cities/bonito.png",                routeOrder: 4  },
    { name: "Porto Murtinho",         country: "BR", state: "Mato Grosso do Sul",    population: "12.859",  tagline: "A Guardiã do Rio Paraguai",                desc: "Última cidade brasileira antes da travessia. Pantanal, Toro Candil e a ponte binacional sobre o Rio Paraguai.",                     href: "/cidades/porto-murtinho",        accent: "#F4A261", accentRgb: "244,162,97",   image: "/cities/porto_murtinho.png",        routeOrder: 5  },
    { name: "Carmelo Peralta",        country: "PY", state: "Alto Paraguay",         population: "5.000",   tagline: "A Travessia Histórica",                    desc: "Fronteira com Porto Murtinho — onde a ponte binacional sobre o Rio Paraguai conecta dois oceanos.",                                   href: "/cidades/carmelo-peralta",       accent: "#818cf8", accentRgb: "129,140,248",  image: "/cities/carmelo_peralta.png",       routeOrder: 6  },
    ...
    { name: "Filadelfia",             country: "PY", state: "Boquerón",              population: "14.000",  tagline: "A Alma Europeia do Chaco",                 desc: "Colônia mennonita que transformou o deserto em polo agroindustrial. Queijos, embutidos e cooperativismo.",                           href: "/cidades/filadelfia",            accent: "#84cc16", accentRgb: "132,204,22",   image: "/cities/filadelfia.png",            routeOrder: 8  },
    { name: "Tartagal",               country: "AR", state: "Salta — NOA",           population: "70.000",  tagline: "Fronteira Cultural do Norte Argentino",    desc: "Cinco povos originários ativos, floresta subtropical das Yungas e carnaval multicultural do NOA.",                                   href: "/cidades/tartagal",              accent: "#10b981", accentRgb: "16,185,129",   image: "/cities/tartagal.png",              routeOrder: 9  },
    { name: "Jujuy",                  country: "AR", state: "Província de Jujuy",    population: "320.000", tagline: "A Alma Ancestral dos Andes",               desc: "Quebrada de Humahuaca (UNESCO), Cerro de los Siete Colores e Pachamama viva há 10.000 anos.",                                         href: "/cidades/jujuy",                 accent: "#f43f5e", accentRgb: "244,63,94",    image: "/cities/jujuy.png",                 routeOrder: 10 },
    { name: "Salta",                  country: "AR", state: "Província de Salta",    population: "620.000", tagline: "La Linda — Capital do Folclore Andino",    desc: "Centro histórico colonial, Tren a las Nubes a 4.220m e peñas folclóricas com zamba ao vivo.",                                      href: "/cidades/salta",                 accent: "#f97316", accentRgb: "249,115,22",   image: "/cities/salta.png",                 routeOrder: 11 },
    { name: "Antofagasta",            country: "CL", state: "Região de Antofagasta", population: "500.000", tagline: "Onde o Atacama Beija o Pacífico",          desc: "La Portada, observatórios ESO, capital do cobre e o porto onde o continente encontra o oceano.",                                      href: "/cidades/antofagasta",           accent: "#38bdf8", accentRgb: "56,189,248",   image: "/cities/antofagasta.png",           routeOrder: 12 },
    { name: "Iquique",                country: "CL", state: "Região de Tarapacá",    population: "235.000", tagline: "Porto Histórico e Zona Franca",            desc: "Humberstone UNESCO, Cerro Dragón, memória salitreira e ZOFRI — a cidade que se reinventou sem perder a alma.",                      href: "/cidades/iquique",               accent: "#fb923c", accentRgb: "251,146,60",   image: "/cities/iquique.png",               routeOrder: 13 },
    { name: "Mejillones",             country: "CL", state: "Região de Antofagasta", population: "12.000",  tagline: "O Porto Autêntico do Pacífico",            desc: "Encerramento simbólico da rota. Porto artesanal centenário, pesca viva e o pôr do sol mais emocionante da travessia.",              href: "/cidades/mejillones",            accent: "#0891b2", accentRgb: "8,145,178",    image: "/cities/mejillones.png",            routeOrder: 14 },
];

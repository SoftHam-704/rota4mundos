...
export default function HeroSection() {
    ...
    useEffect(() => {
        ...
        class Particle {
            ...
            draw() {
                ...
                ctx.fillStyle = `rgba(244, 162, 97, ${this.opacity})`;
                ctx.fill();
            }
        }
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary-950">
            ...
            <div className="absolute inset-0 z-[1] bg-gradient-to-b from-primary-950/55 via-primary-950/30 to-primary-950/85" />
